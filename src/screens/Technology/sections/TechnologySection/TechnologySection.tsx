      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col tablet:flex-row-reverse gap-[60px] tablet:gap-[80px] mt-8 tablet:mt-12 items-start">
          ...
          <div className="flex-1 space-y-5 max-w-[954px]">
            <h2 className="text-[20px] leading-[27px] font-normal font-inter text-[#1C1C1C] desktop:text-[26px] desktop:leading-[34px] desktop:font-normal">
              System integration
            </h2>
            <p className="text-[16px] leading-[22px] font-light font-inter text-[#1C1C1C] desktop:text-[18px] desktop:leading-[24px] desktop:font-normal">
            ...
            <Button variant="ghost" className="inline-flex items-center gap-2.5 p-0 rounded-[30px] hover:bg-transparent">
              <span className="text-primary-colour font-inter">Learn more</span>
        ...
        <div className="max-w-[783px] mt-[60px] tablet:mt-[80px] ml-0 tablet:ml-[60px] desktop:ml-[160px]">
          <div className="space-y-5">
            ...
            <p className="text-[16px] leading-[22px] font-normal font-inter text-[#1C1C1C] desktop:text-[18px] desktop:leading-[24px]">
