      ...
      <section className="w-full flex justify-center">
        ...
        >
          <div className="w-1/2 flex justify-start pr-6">
            <h1 className="relative z-10 text-left text-[#1C1C1C] font-[300] text-[26px] leading-[32px] tablet:text-[32px] tablet:leading-[40px] font-['Space_Grotesk'] max-w-[748px]">
              {heroSection.text}{" "}
        ...
        >
          <h1 className="z-10 px-4 pb-4 text-[#1C1C1C] font-[300] text-[20px] leading-[28px] font-['Space_Grotesk'] max-w-[360px]">
            {heroSection.text}{" "}
            <span className="bg-gradient-to-tr from-[#AADA5D] to-[#0DAEB9] bg-clip-text text-transparent font-bold">
              {heroSection.highlightedtext}
            </span>
