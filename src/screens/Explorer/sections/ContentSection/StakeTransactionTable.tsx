    ...
    return (
      <div className="bg-white p-1 md:p-5 w-full">
        ...
        <div className="grid md:grid-cols-[180px_1fr] gap-y-1 md:gap-y-4 text-[14px] leading-[19px] text-gray-700">
          ...
          <div className="text-[#858585] md:text-[#1C1C1C]">Stake method</div>
          ...
          <div className="text-[#858585] md:text-[#1C1C1C]">Stake node</div>
          <div className="flex gap-2 items-center">
            <span className="truncate max-w-full">{selectedRow.stakeNode}</span>{" "}
            <img src="/copy.svg" />
          </div>
          <hr className="md:hidden my-1" />
