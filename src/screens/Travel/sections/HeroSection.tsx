...
export const HeroSection = (): JSX.Element => {
  ...
  return (
    <section className="">
        ...
        className='max-h-[175px] md:max-h-[300px] xl:max-h-[400px] desktop:max-h-[450px]'
        >
            <CarouselContent className='px-[15px] md:px-[60px] xl:px-[70px] large:px-[273px]'>
                <h1 className='text-[#CDFAFF] font-bold uppercase text-[50px] leading-[45px] xl:text-[150px] xl:leading-[160px] desktop:text-[150px] desktop:leading-[160px]'>
                    LUCA.TRAVEL
                </h1>
            </CarouselContent>
        </TravelCarousel>
