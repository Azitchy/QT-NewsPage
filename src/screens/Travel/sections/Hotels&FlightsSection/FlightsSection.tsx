    ...
    <section className="pt-[60px] xl:pt-[100px]">
      ...
      <div className="pt-[20px] px-0 tablet:px-[77px] xl:px-[134px] large:px-[203px] space-y-[15px] xl:space-y-[20px]">
        ...
        <div className="flex gap-[10px]">
          ...
          />
          <img
            src="/lucatravel-dark.svg"
            alt="Luca Travel"
            className="hidden dark:block"
            loading="lazy"
          />
          <span className="text-[18px] font-light leading-[24px] xl:text-[20px] xl:leading-[27px]">
            {" "}
            {t("flightsSection.partnerText")}{" "}
          </span>
          <img src="/trip.com.svg" alt="Trip.com" loading="lazy" />
        </div>
