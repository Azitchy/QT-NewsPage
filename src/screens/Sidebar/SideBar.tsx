...
//       className={`text-base mt-3 cursor-pointer transition-colors duration-200 ${
...
//     return (
//       <>
//         <h1 className="text-[20px] font-normal text-foreground">{title}</h1>
...
//             <div className="flex flex-col items-center space-y-4 mt-auto pt-40">
