      ...
      <div className="flex flex-col w-full lg:w-[232px] items-start lg:items-end lg:absolute lg:top-[60px] lg:left-0  lg:mb-0">
        <div className="relative w-full lg:w-[225px] h-[99px]">
          <div className="relative w-full lg:w-[232px] h-[99px] lg:ml-[71px]">
            <HeadingWithDots text={t("letsConnectSection.title")} />
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row w-full items-end justify-between px-0 lg:px-[71px] gap-8 lg:gap-10">
        <div className="relative w-full lg:w-[577px]">
          <div className="relative w-full lg:w-[621px] h-auto lg:h-[648px] lg:top-[-60px] lg:-left-2">
            ...
            >
              <div className="relative w-full lg:w-[587px] mt-[-1.00px] font-inter font-normal text-foreground dark:text-foreground text-[16px] lg:text-[18px] tracking-[0px] leading-[22px] lg:leading-[24px]">
              ...
              <div className="inline-flex flex-row items-stretch sm:items-center gap-2.5 w-full">
                <div className="dark:border-gradient rounded-[10px]">
                  <Input
                    className="w-[200px] sm:flex-1 lg:w-[378.62px] h-[43px] px-[20px] py-2.5 bg-background dark:bg-background rounded-[10px] border border-border overflow-hidden text-ellipsis"
                ...
                >
                  {isSubscribing
                    ? t("letsConnectSection.subscription.subscribing")
                    : t("letsConnectSection.subscription.button")}
                </Button>
              </div>
            </form>
          </div>
        ...
        <div className="w-full lg:w-[780px] h-auto lg:h-[468px] gap-[15px] lg:mb-14 large:mr-[300px] flex flex-col items-start order-1 lg:order-2  lg:px-0">
          <div className="relative self-stretch mt-[-1.00px] font-inter font-normal text-foreground dark:text-foreground text-[16px] lg:text-[18px] tracking-[0px] leading-[22px] lg:leading-[24px]">
            {t("letsConnectSection.form.title")}
          </div>

          <Card className="h-auto lg:h-[429px] w-full bg-card rounded-[20px] border border-border dark:border-gradient">
            <CardContent className="flex flex-col items-start gap-5 px-6 lg:px-[45px] py-6 lg:py-[30px] h-full relative bg-card rounded-[20px]">
              <form onSubmit={handleFormSubmit} className="w-full flex flex-col gap-5">
                <Input
                  className="w-full lg:w-1/2  h-[43px] px-[15px] py-2.5 bg-white dark:bg-[#090920] rounded-[10px] border border-border"
                ...
                <Input
                  className="w-full lg:w-1/2 h-[43px] px-[15px] py-2.5 bg-background dark:bg-background rounded-[10px] border border-border"
                ...
                <Textarea
                  className="h-[100px] w-full px-5 pt-[15px] pb-2.5 bg-background dark:bg-background rounded-[10px] border border-border text-[#4f5555]"
                ...
                >
                  {isSubmitting
                    ? t("letsConnectSection.form.submitting")
                    : isFormSubmitted
                    ? t("letsConnectSection.form.submitted")
                    : t("letsConnectSection.form.submitButton")}
                </Button>
              </form>
            </CardContent>
          </Card>
