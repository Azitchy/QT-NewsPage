...
function DashboardStatCard({
  ...
  return (
    <div className="flex-1 min-w-[250px] lg:h-[160px] shrink-0 rounded-[15px] bg-gradient-to-b from-[#8E1BF4] to-[#100CD8] p-[20px] flex flex-col justify-between text-white">
      <div>
        <p className="text-[18px] text-[#EFEFEF] font-medium">{title}</p>
        <div className="text-[36px] font-light text-[#EFEFEF]">{value}</div>
      </div>
      ...
      <div className="flex justify-end">
        {showButton ? (
          <div
            ...
            className="bg-white rounded-[30px] px-[15px] py-[8px] w-fit cursor-pointer"
          >
          ...
          <div className="px-[15px] py-[8px] w-fit">
...
function LucaBalanceCard({
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-[20px]">
      <DashboardStatCard title="Avatar PR" value="0" icon={InsightIcon} />

      <DashboardStatCard title="Your connections" value="1" icon={HubIcon} />

      <DashboardStatCard
        title="You have spent"
        value={
          <>
            {spent}/{total}{" "}
            <span className="text-[24px] font-normal">{currency}</span>
          </>
        }
        showButton
        buttonText="Top up the balance"
      />
    </div>
  );
}
